													...
													<div id="iFilePic"
														...
														<div
															...
															<a class="photoBiger"
																href="http://van.ipimg.com/ialbum/34/15/80/07/7801534/photo_1472801276.jpg">
																<img height='400px' width='300px'
																src='${pageContext.servletContext.contextPath}/_00_init/getImage?id=${RandomFriend.members_ID}&type=LUCKY' />
															</a>
														</div>
													</div>
												</td>
									...
									<td colspan="2"
										...
										<div
											...
											<table width="100%" border="0" cellpadding="2"
												...
												<tr>
													<td align="left" width="50%" nowrap style="font-size: 11pt"><font
														color="white">暱 稱：</font>${RandomFriend.members_Name}</td>
												...
												<tr>
													...
													<!-- 	這要記得+EL -->
													<td align="left" colspan="2" style="font-size: 11pt"><font
														color="white">星座：</font>${RandomFriend.members_Constellation}</td>
												</tr>
												<tr>
													<td align="left" style="font-size: 11pt"><font
														color="white">身高：</font> ${RandomFriend.members_Height}</td>
													<td align="left" colspan="2" style="font-size: 11pt"><font
														color="white">現居：</font> ${RandomFriend.members_City}</td>
												</tr>
												<tr>
													<td align="left" style="font-size: 11pt"><font
														color="white">體 重：</font> ${RandomFriend.members_Weight}</td>
													<td align="left" colspan="2" style="font-size: 11pt"><font
														color="white">地區：</font> ${RandomFriend.members_Area}</td>
												</tr>
												<tr>

													<td align="left" colspan="2" style="font-size: 11pt"><font
														color="white">職 業：</font> ${RandomFriend.members_Job}</td>
												</tr>
												<tr>
													<td colspan="3" style="font-size: 11pt"></td>
												</tr>
